...
if exists('g:lightline')
  ...
  let s:p.normal.left     = [ [ s:white, s:xgrey4 ], [ s:white, s:xgrey2 ] ]
  let s:p.normal.right    = [ [ s:white, s:xgrey4 ], [ s:white, s:xgrey2 ] ]
  ...
  let s:p.visual.left     = [ [ s:black, s:cyan ], [ s:white, s:xgrey4 ] ]
  let s:p.visual.right    = [ [ s:black, s:cyan ], [ s:white, s:xgrey4 ] ]
